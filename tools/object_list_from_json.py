...
Note (uni2bim mode):
  To run main.py in uni2bim mode through scale_runner/batch_scale_from_json, either append
  "-- --mode uni2bim" to the orchestrator command, or use "--mode uni2bim" on
  tools/batch_scale_from_json.py directly.
"""
